...
export function Label({ values, setValues, removeLabel }: Props) {
  ...
  return (
    <div className="grid grid-rows-2 grid-cols-5 md:grid-rows-1 gap-1 p-2 bg-base-100 shadow rounded">
      <input
        type="text"
        className="input-sm input-bordered col-span-5 input w-full rounded"
      ...
      <input
        type="text"
        className="input-sm input-bordered input col-span-3 w-full rounded"
      ...
      <input
        type="number"
        className="input-sm input-bordered input w-full rounded"
